    ...
    <div>
      ...
      <section>
        ...
        <div className='w-[62%] h-[560px] px-8 text-justify'>
         ...
         {/* horizontal line */}
         <div className=' mx-32 my-10 h-[2px] bg-black'></div> 
        ...
        <div className='md:flex p-20 '>
        <div className='w-[62%] h-[560px] px-8 text-justify'>
                <h1 className='font-semibold text-5xl pb-6'>Home Water Filters</h1>
                <p className='text-[24px]'>
        ...
        <div className='md:flex p-20 '>
            ...
            <div className='md:w-[62%] h-[560px] md:px-8 text-justify'>
                <h1 className='font-semibold text-5xl p-6'>Food / Beverage</h1>
                <p className='text-[24px]'>Activated carbons; It removes contaminants and impurities such as color and odor from sweeteners, food liquids, syrups, beverages, glycerin, amino and organic acids.</p>
            </div>
        ...
        <div className='md:flex p-20 '>
        <div className='w-[62%] h-[560px] px-8 text-justify'>
                <h1 className='font-semibold text-5xl pb-6'>Personal Protection</h1>
                <p className='text-[24px]'>
        ...
        <div className='md:flex p-20 '>
        <div className='w-[62%] h-[560px] px-8 text-justify'>
                <h1 className='font-semibold text-5xl pb-6'>Flue Gas / Mercury</h1>
                <p className='text-[24px]'>
        ...
        <div className='md:flex p-20 '>
            ...
            <div className='md:w-[62%] h-[560px] md:px-8 text-justify'>
                <h1 className='font-semibold text-5xl p-6'>Pharmaceutical / Medical</h1>
                <p className='text-[24px]'>The pharmaceuticals may be contaminated by proteins or other organic compounds during production. Different grades of activated carbons can be used to make these products suitable for use.
        ...
        <div className='md:flex p-20 '>
        <div className='w-[62%] h-[560px] px-8 text-justify'>
                <h1 className='font-semibold text-5xl pb-6'>Gold Mining</h1>
                <p className='text-[24px]'>
...
CG Carbon’s expertise and experience provide economical and efficient solutions for a wide range of metal recovery applications.
        ...
        <div className='md:flex p-20 '>
            ...
            <div className='md:w-[62%] h-[560px] md:px-8 text-justify'>
                <h1 className='font-semibold text-5xl p-6'>Tobacco</h1>
                <p className='text-[24px]'> It is used in cigarette filters to affect cigarette and aroma properties and to remove unwanted cigarette components from cigarette smoke.
                Activated Carbon Filters provide removal of carcinogens and other toxic components that cannot be eliminated by ordinary carbonless filters.</p>
            </div>
        ...
        <div className='md:flex p-20 '>
        <div className='w-[62%] h-[560px] px-8 text-justify'>
                <h1 className='font-semibold text-5xl pb-6'>Automotive</h1>
                <p className='text-[24px]'>
